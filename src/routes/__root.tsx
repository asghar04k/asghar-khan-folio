  ...
  head: () => ({
    meta: [
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/167c1145b1ac5ca30ea8db65ebd7345b/id-preview-55ef7809--f049bbc4-9603-4520-952a-721fddf9d4df.lovable.app-1786223289158.png",
      },
      {
        name: "twitter:image",
        content:
